<svg xmlns="http://www.w3.org/2000/svg" width="{{#if width}}{{width}}{{else}}120{{/if}}" height="32" viewBox="0 0 {{#if width}}{{width}}{{else}}120{{/if}} 32">
  <defs>
    <linearGradient id="tagGrad-{{_id}}" x1="0%" y1="0%" x2="100%" y2="0%">
